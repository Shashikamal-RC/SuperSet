...
def log_to_google_sheet(data: dict):
    ...
    headers = [
        ...
        "Min CTC", "Max CTC", "Role Family", "Posting Type",  "JD Generated by AI"
    ]
    ...
    values.append([
        formatted_timestamp,
        data.get('Posted by', data.get('posted_by', 'N/A')),
        ...
        data.get('Role Family',  data.get('role_family', 'N/A')),
        data.get('Posting Type',  data.get('posting_type', 'N/A')),
        data.get('Week of Job Posted',  data.get('Week of Job Posted', 'N/A')),
        data.get('JD Generated by AI',  data.get('is_ai_generated', 'No')),
    ])
